 import image_30 from "../../assets/service/test_30.png";
//  import image_31 from "../../assets/service/image_31.png";
// import image_32 from "../../assets/service/image_32.png";
//  import image_33 from "../../assets/service/image_33.png";
...
const Testimonials = () => {
  ...
  return (
    <section className="py-12 px-6">
      ...
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-8 text-white font-family-urbanist">
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <div className="flex items-center justify-between py-7">
              <img
                className="object-cover w-16 sm:w-20 rounded-full"
                src={testimonial?.img}
                alt={testimonial.name}
              />
              <div className="flex flex-col items-start justify-items-start pr-11">
                <h3 className="text-lg sm:text-lg font-bold text-white font-family-urbanist mb-1">
                  {testimonial.name}
                </h3>
